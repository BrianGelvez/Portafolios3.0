...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Brian Gelvez</title>
            <meta name="description" content="Explore articles authored by Brian Gelvez, a Full Stack Engineer and Developer." />
