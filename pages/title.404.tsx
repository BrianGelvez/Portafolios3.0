...
export default function Title404() {
    return (
        <Head>
            ...
            <title>404 - Page Not Found | Brian Gelvez</title>
            ...
            <meta name="keywords" content="404, Page Not Found, Brian Gelvez, Portfolio,broken link ,missing page,link not found" />
