...
export default function Title500() {
    return (
        <Head>
            ...
            {/*
				Author: Brian Gelvez
                 GitHub: Visit the GitHub repository at https://github.com/Brian Gelvez
                 license: MIT License
                  */}
            <meta charSet="utf-8" />
            <meta httpEquiv="X-UA-Compatible" content="IE=edge" />
            <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
            <title>500: internal server error | Brian Gelvez</title>
            ...
            <meta name="keywords" content="500, internal server error, Brian Gelvez, Portfolio,broken link ,missing page,link not found" />
